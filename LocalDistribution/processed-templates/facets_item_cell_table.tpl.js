define('facets_item_cell_table.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return " <div class=\"facets-item-cell-table-rating\" itemprop=\"aggregateRating\" itemscope itemtype=\"http://schema.org/AggregateRating\"  data-view=\"GlobalViews.StarRating\"></div> ";
  },"5":function(depth0,helpers,partials,data) {
  var helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return " <form class=\"facets-item-cell-table-add-to-cart\" data-toggle=\"add-to-cart\"><input class=\"facets-item-cell-table-add-to-cart-itemid\" type=\"hidden\" value=\""
    ...
    + "\" name=\"item_id\"><input class=\"facets-item-cell-table-add-to-cart-quantity\" name=\"quantity\" type=\"number\" min=\"1\" value=\""
    ...
    + "\"><input class=\"facets-item-cell-table-add-to-cart-button\" type=\"submit\" value=\"Add to Cart\"></form> ";
},"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, lambda=this.lambda, buffer = " <div class=\"facets-item-cell-table\" itemprop=\"itemListElement\"  data-item-id=\""
    + escapeExpression(((helper = (helper = compilerNameLookup(helpers,"itemId") || (depth0 != null ? compilerNameLookup(depth0,"itemId") : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"itemId","hash":{},"data":data}) : helper)))
  ...
  buffer += " </div><h2 class=\"facets-item-cell-table-title\"><a href=\""
    + escapeExpression(((helper = (helper = compilerNameLookup(helpers,"url") || (depth0 != null ? compilerNameLookup(depth0,"url") : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"url","hash":{},"data":data}) : helper)))
    + "\"><span itemprop=\"name\"> "
    ...
    + " </span></a></h2><div class=\"facets-item-cell-table-price\"><div data-view=\"ItemViews.Price\"></div></div> ";
  ...
  stack1 = compilerNameLookup(helpers,"if").call(depth0, (depth0 != null ? compilerNameLookup(depth0,"canAddToCart") : depth0), {"name":"if","hash":{},"fn":this.program(5, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + " <div class=\"facets-item-cell-table-stock\"><div data-view=\"ItemViews.Stock\"></div></div></div> ";
