define('item_views_cell_navigable_actionable.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  var stack1, helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = " <a class=\"item-views-cell-navigable-actionable-product-title-anchor\" ";
  ...
  return " <span class=\"item-views-cell-navigable-actionable-product-title\"> "
    + escapeExpression(((helper = (helper = compilerNameLookup(helpers,"itemName") || (depth0 != null ? compilerNameLookup(depth0,"itemName") : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"itemName","hash":{},"data":data}) : helper)))
    + " </span> ";
  ...
  var helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return " <span class=\"item-views-cell-navigable-actionable-item-unit-price-label\">"
  ...
  var helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return " <span class=\"item-views-cell-navigable-actionable-item-amount-label\">"
  ...
  var helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return " <small class=\"item-views-cell-navigable-actionable-item-old-price\">"
  ...
  var stack1, helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = " <tr class=\"item-views-cell-navigable-actionable "
    ...
    + "\"><td class=\"item-views-cell-navigable-actionable-item-image\" name=\"item-image\"><img src=\""
    ...
    + "\"></td><td class=\"item-views-cell-navigable-actionable-details\" name=\"item-details\"><p class=\"item-views-cell-navigable-actionable-product-name\"> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " </p><p><span class=\"item-views-cell-navigable-actionable-sku-label\">"
    ...
    + "</span><span class=\"item-views-cell-navigable-actionable-sku-value\"> "
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " </td><td class=\"item-views-cell-navigable-actionable-item-unit-price\" name=\"item-totalprice\"><p> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " <span class=\"item-views-cell-navigable-actionable-item-reason-value\"> "
    ...
    + "</span></p></td><td class=\"item-views-cell-navigable-actionable-item-quantity\" name=\"item-quantity\"><p><span class=\"item-views-cell-navigable-actionable-item-quantity-label\">"
    ...
    + "</span><span class=\"item-views-cell-navigable-actionable-item-quantity-value\"> "
    ...
    + "</span></p></td><td class=\"item-views-cell-navigable-actionable-amount\" name=\"item-amount\"><p> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " <span class=\"item-views-cell-navigable-actionable-item-amount-value\"> "
...
},"useData":true}); template.Name = 'item_views_cell_navigable_actionable'; return template;});