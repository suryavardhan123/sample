define('quote_list.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return " <table class=\"quote-list-quotes-table\"><thead class=\"quote-list-content-table\"><tr class=\"quote-list-content-table-header-row\"><th class=\"quote-list-content-table-header-row-title\"><span>"
    + escapeExpression(((compilerNameLookup(helpers,"translate") || (depth0 && compilerNameLookup(depth0,"translate")) || helperMissing).call(depth0, "Quote No.", {"name":"translate","hash":{},"data":data})))
  ...
  return " <div class=\"quote-list-empty-section\"><h5>"
    + escapeExpression(((compilerNameLookup(helpers,"translate") || (depth0 && compilerNameLookup(depth0,"translate")) || helperMissing).call(depth0, "No quotes were found", {"name":"translate","hash":{},"data":data})))
    + "</h5></div> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " <section class=\"quote-list\"><header class=\"quote-list-header\"><h2>"
  ...
  stack1 = compilerNameLookup(helpers,"if").call(depth0, (depth0 != null ? compilerNameLookup(depth0,"collectionLength") : depth0), {"name":"if","hash":{},"fn":this.program(3, data),"inverse":this.program(5, data),"data":data});
  if (stack1 != null) { buffer += stack1; }
