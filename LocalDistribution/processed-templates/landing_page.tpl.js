define('landing_page.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  var stack1, helper, functionType="function", helperMissing=helpers.helperMissing, buffer = " <div id=\"landing-page-content\" class=\"landing-page-content\"> ";
  ...
  var stack1, buffer = " <div class=\"landing-page-header\"> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += " <div id=\"main-banner\" class=\"landing-page-main-banner\"></div></div> ";
  ...
  if (stack1 != null) { buffer += stack1; }
  return buffer;
},"useData":true}); template.Name = 'landing_page'; return template;});