define('payment_wizard_layout.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return buffer + " <div id=\"wizard-content\" class=\"payment-wizard-layout-content\"></div>";
