...
<div class="address-edit-fields">
	...
	<div class="address-edit-fields-group" data-input="firstname" data-validation="control-group">
		...
		<div  class="address-edit-fields-group-form-controls" data-validation="control">
			<input type="text" class="address-edit-fields-group-input" id="{{manage}}firstname" name="firstname" value="{{firstName}}">
		</div>
	</div>
	...
	<div class="address-edit-fields-group" data-input="lastname" data-validation="control-group">
		...
		<div  class="address-edit-fields-group-form-controls" data-validation="control">
			<input type="text" class="address-edit-fields-group-input" id="{{manage}}lastname" name="lastname" value="{{lastName}}">
		</div>
	</div>
	{{#if showCompanyField}}
	...
	<div class="address-edit-fields-group address-edit-fields-group-big" data-input="addr2">
		<label for="{{manage}}addr2">
			<p class="address-edit-fields-addr2-optional-label">{{translate '(optional)'}}</p>
		</label>
		<div>
	...
	<div class="address-edit-fields-group"  data-input="phone" data-validation="control-group">
		...
		<div  class="address-edit-fields-group-form-controls" data-validation="control">
			<input type="tel" class="address-edit-fields-group-input" id="{{manage}}phone" name="phone" value="{{phone}}" data-action="inputphone" onchange='fullnamefun();'>
	...
	<div class="address-edit-fields-group" data-input="isresidential">
		<label class="address-edit-fields-group-input-checkbox">
			...
			<a href="#" rel="tooltip" data-toggle="tooltip" title="{{translate 'Indicating that this is a residential address will help us determine the best delivery method for your items.'}}">
				<i class="address-edit-fields-icon-question-sign"></i>
			</a>
		</label>
	</div>
