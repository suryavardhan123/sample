...
_(Tool.prototype).extend({
	...
	main: function()
	{
		...
		// .then(function()
		// {
		// 	self.credentials = mocked_credentials
...
,	selectOneFolder: function(parentFolder)
	{		
		var deferred = Q.defer()
		,	self = this
		self.listFolderChildren(parentFolder).then(function(recordList)
		{
			...
			//TODO: if(!choices||!choices.length){}
			inquirer.prompt([{
				type: 'list'
			,	name: 'targetFolder'
			...
			{
				// console.log('targetFolder answers', answers)
...
// var mocked_credentials = {
//   'email': 's@gurin.com',
//   'password': 'test098',
//   'role': {
//     'account': {
//       'internalId': '3690872',
//       'name': 'Cabo Polonio Store - PSG_Automation'
//     },
//     'role': {
//       'internalId': 3,
//       'name': 'Administrator'
